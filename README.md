...
|:--:|:--------------:|:--------------:|:--------------:|
| 1 |  -Caesar-s-Cipher-Decryption             |  -Caesar-s-Cipher-Decryption Decryption With Caesars Cipher             | https://https://github.com/David-Kojo-Kenyarko/Caesar-s-Cipher-Decryption.git       |
| 2 |  -Statistics-in-Data-Analytics             |  -Statistics-in-Data-Analytics Round to the nearest whole number.             | https://https://github.com/David-Kojo-Kenyarko/Statistics-in-Data-Analytics.git       |
| 3 |  -Grocery-Store-Analysis             |  -Grocery-Store-Analysis Grocery Store Analysis With Excel             | https://https://github.com/David-Kojo-Kenyarko/-Grocery-Store-Analysis.git       |
